...
; DD E1 - POP IX
POPREGW         DDE1,regeix,14

; DD E3 - EX (SP),IX
OPEXSPREGW      DDE3,regeix,23

; DD E5 - PUSH IX
PUSHREGW        DDE5,regeix,15

; DD E9 - JP (IX)
OPJPREGW        DDE9,regeix,8

; DD F9 - LD SP,IX
LDSPREGW        DDF9,regeix,10
