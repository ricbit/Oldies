...
; FD 09 - ADD IY,BC
ADDREGWREGW     FD09,regiyl,regiyh,regc,regb,15

; FD 19 - ADD IY,DE
ADDREGWREGW     FD19,regiyl,regiyh,rege,regd,15

; FD 21 - LD IY,dddd
LDREGWIMM      FD21,regeiy

; FD 22 - LD (dddd),IY
LDDDDDREGW      FD22,regeiy,20
...
; FD 29 - ADD IY,IY
ADDREGWREGW     FD29,regiyl,regiyh,regiyl,regiyh,15

; FD 2A - LD IY,(dddd)
LDREGWDDDD      FD2A,regeiy,20
...
; FD 39 - ADD IY,SP
ADDREGWREGW     FD39,regiyl,regiyh,regspl,regsph,15
...
; FD E1 - POP IY
POPREGW         FDE1,regeiy,14

; FD E3 - EX (SP),IY
OPEXSPREGW      FDE3,regeiy,23

; FD E5 - PUSH IY
PUSHREGW        FDE5,regeiy,15

; FD E9 - JP (IY)
OPJPREGW        FDE9,regeiy,8

; FD F9 - LD SP,IY
LDSPREGW        FDF9,regeiy,10
