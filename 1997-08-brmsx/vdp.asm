...
public foregroundcolor_MMX
public backgroundcolor_MMX
public colorsave
public scr2inc         
public scr2inc_color   
public scr2offset      
public bitmask
public render_screen3
...
render_screen2:
                cmp     msxmodel,0
                jne     render_screen2_msx2
                
                cmp     enginetype,0
                jne     render_screen2_mmx
                RENDER_SCREEN2_MACRO DOS_ENGINE,MSX1_RENDER,blitbuffer

render_screen2_mmx:
                RENDER_SCREEN2_MACRO MMX_ENGINE,MSX1_RENDER,blitbuffer
...
eval_screen4:
                ...
                mov     al,byte ptr [offset vdpregs+3]
                mov     ah,byte ptr [offset vdpregs+10]
                and     eax,780h
                shl     eax,6
                mov     colortable,eax
